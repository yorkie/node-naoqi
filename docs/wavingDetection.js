/**
 * @module wavingDetection
 */
session.wavingDetection = {
  /**
   * 
  ...
  'setMaxDistance': function setMaxDistance(maxDistance) {
    return session.setMaxDistance(maxDistance);
  },
  /**
   ...
   * @return null
   */
  'setMinSize': function setMinSize(sensitivity) {
    return session.setMinSize(sensitivity);
  },
  /**
