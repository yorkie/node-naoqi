/**
 * @module voiceEmotionAnalysis
 */
session.voiceEmotionAnalysis = {
  /**
   * 
   ...
   * @method _onSpeechDetected
   * @private
   * @param key - ALMemory key.
   * @param value - ALValue of key.
   * @return null
   */
  '_onSpeechDetected': function _onSpeechDetected(key, value) {
    return session._onSpeechDetected(key, value);
  },
  /**
