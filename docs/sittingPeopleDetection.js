/**
 * @module sittingPeopleDetection
 */
session.sittingPeopleDetection = {
  /**
   * 
   ...
   * @method setSittingThreshold
   * @param threshold - float, face height (in meter) from the ground under which we consider thatsomeone is sitting.
   * @return null
   */
  'setSittingThreshold': function setSittingThreshold(threshold) {
    return session.setSittingThreshold(threshold);
  },
  /**
   * Gets sitting threshold
   * @method getSittingThreshold
   * @return Maximum face height in meter
   */
  'getSittingThreshold': function getSittingThreshold() {
    return session.getSittingThreshold();
  },
};
