...
session.notificationManager = {
   ...
   * Add a notification.
   * @method add
   * @param notification - Contain information for the notification
   * @return Notification ID.
   */
  'add': function add(notification) {
    return session.add(notification);
  },
  /**
  ...
  'remove': function remove(notificationId) {
    return session.remove(notificationId);
  },
  /**
  ...
  'notification': function notification(notificationId) {
    return session.notification(notificationId);
  },
  /**
   * 
   * @method _internalNotifications
   * @private
   * @return An array of pending notification.
   */
  '_internalNotifications': function _internalNotifications() {
    return session._internalNotifications();
  },
  /**
   * 
   * @method _internalNotification
   * @private
   * @param notificationId - Notification ID.
   * @return ALValue containing a Notification.
   */
  '_internalNotification': function _internalNotification(notificationId) {
    return session._internalNotification(notificationId);
  },
  /**
   * 
   * @method _severity
   * @private
   * @return Maximal Notification severity.
   */
  '_severity': function _severity() {
    return session._severity();
  },
  /**
   * 
   * @method _read
   ...
   * @return null
   */
  '_read': function _read(int) {
    return session._read(int);
  },
  /**
   * 
   * @method _isImmediate
   * @private
   * @param notificationId - Notification ID.
   * @return True if the notification is immediate, false otherwise.
   */
  '_isImmediate': function _isImmediate(notificationId) {
    return session._isImmediate(notificationId);
  },
};
