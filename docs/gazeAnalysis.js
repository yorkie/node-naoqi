...
session.gazeAnalysis = {
   ...
   * @method setFaceAnalysisEnabled
   * @param status - True to turn it on, False to turn it off.
   * @return null
   */
  'setFaceAnalysisEnabled': function setFaceAnalysisEnabled(status) {
    return session.setFaceAnalysisEnabled(status);
  },
  /**
   * Gets the current status of face analysis.
   * @method isFaceAnalysisEnabled
   * @return True if face analysis is enabled, False otherwise.
   */
  'isFaceAnalysisEnabled': function isFaceAnalysisEnabled() {
    return session.isFaceAnalysisEnabled();
  },
  /**
  ...
  'setTolerance': function setTolerance(tolerance) {
    return session.setTolerance(tolerance);
  },
  /**
