/**
 * @module visualSpaceHistory
 */
session.visualSpaceHistory = {
  /**
   * 
   ...
   * @return null
   */
  'setGridPrecision': function setGridPrecision(precision) {
    return session.setGridPrecision(precision);
  },
  /**
   * Gets grid precision
   * @method getGridPrecision
   * @return Grid precision
   */
  'getGridPrecision': function getGridPrecision() {
    return session.getGridPrecision();
  },
  /**
