/**
 * @module darknessDetection
 */
session.darknessDetection = {
  /**
   * 
   ...
   * @method setDarknessThreshold
   * @param threshold - New darkness threshold (between 0 and 100)
   * @return null
   */
  'setDarknessThreshold': function setDarknessThreshold(threshold) {
    return session.setDarknessThreshold(threshold);
  },
  /**
   * Returns the current DarknessThreshold for isItDark
   * @method getDarknessThreshold
   * @return Current darkness threshold value
   */
  'getDarknessThreshold': function getDarknessThreshold() {
    return session.getDarknessThreshold();
  },
};
