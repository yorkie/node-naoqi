/**
 * @module faceCharacteristics
 */
session.faceCharacteristics = {
  /**
   * 
   ...
   * @method analyzeFaceCharacteristics
   * @param id - Person ID.
   * @return True if the face analysis succeeded, false otherwise.
   */
  'analyzeFaceCharacteristics': function analyzeFaceCharacteristics(id) {
    return session.analyzeFaceCharacteristics(id);
  },
  /**
   * Sets the smile degree threshold above which an event is raised.
   * @method setSmilingThreshold
   * @param threshold - New threshold (must be between 0.0 and 1.0.
   * @return null
   */
  'setSmilingThreshold': function setSmilingThreshold(threshold) {
    return session.setSmilingThreshold(threshold);
  },
  /**
   * Gets the smile degree threshold above which an event is raised.
   * @method getSmilingThreshold
   * @return Threshold for Smiling event
   */
  'getSmilingThreshold': function getSmilingThreshold() {
    return session.getSmilingThreshold();
  },
};
