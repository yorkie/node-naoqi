/**
 * @module colorBlobDetection
 */
session.colorBlobDetection = {
  /**
   * 
   ...
   * @return null
   */
  'setColor': function setColor(r, g, b, colorThres) {
    return session.setColor(r, g, b, colorThres);
  },
  /**
   ...
   * @return null
   */
  'setObjectProperties': function setObjectProperties(minSize, span) {
    return session.setObjectProperties(minSize, span);
  },
  /**
   * Object parameter setting
   * @method setObjectProperties
   ...
   * @return null
   */
  'setObjectProperties': function setObjectProperties(minSize, span, shape) {
    return session.setObjectProperties(minSize, span, shape);
  },
  /**
   ...
   */
  'getAutoExposure': function getAutoExposure() {
    return session.getAutoExposure();
  },
  /**
   ...
   * @return null
   */
  'setAutoExposure': function setAutoExposure(mode) {
    return session.setAutoExposure(mode);
  },
};
