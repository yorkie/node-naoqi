...
session.chestButton = {
   ...
   * @method _setEnableNotifications
   * @private
   * @param enable - If True enable notifications. If False disable notifications.
   * @return null
   */
  '_setEnableNotifications': function _setEnableNotifications(enable) {
    return session._setEnableNotifications(enable);
  },
  /**
   * Return true if notifications are active.
   * @method _areNotificationsEnabled
   * @private
   * @return Return True if notifications are active.
   */
  '_areNotificationsEnabled': function _areNotificationsEnabled() {
    return session._areNotificationsEnabled();
  },
};
